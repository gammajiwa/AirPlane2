...
public class ObjectPoolingManager : MonoBehaviour
{
	...
	public BaseProjectile ProjectileSpawn(ProjectileID projectileID, Vector3 position, Quaternion rotation) {
		return projectilesPoolingManager.Spawn(projectileID, position, rotation);
	}
}
